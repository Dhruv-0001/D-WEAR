      ...
      <div className="container-xxl">
        <div className="row justify-content-center justify-content-md-start">
          <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
            ...
            <div className='mb-3'><p><b>Address:</b>Nawabganj , Kanpur 208002</p> </div>
            <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +91xxxxxxxxxx</a></p> </div>
            ...
            <div className="socials d-flex gap-3">
              ...
              <Link to='https://twitter.com/Dhruvstwt' target='_blank' className='gap-3'>
                <BsTwitter />
                </Link>
                <Link to="https://www.linkedin.com/in/dhruvtyagi15/" target="_blank" rel="noopener noreferrer">
                  <FaLinkedin/>
                </Link>
              <Link to='https://github.com/Dhruv-0001'  target='_blank' className='gap-3'>
                <FaGithub/>
        ...
        <div className="row">
          <div className="col-12 col-md-6">
            <p className="text-center text-md-start">&copy;Developed by Dhruv Tyagi 2023</p>
          </div>
          <div className="col-12 col-md-6">
