          ...
          <div className="row text-center align-items-center">
            <div className="col-lg-6 col-md-12 p-3">
              <div className="map card m-auto embed-responsive embed-responsive-16by9">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28566.198633482436!2d80.28151782845273!3d26.495193930145383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399c383ed475c3db%3A0xc57285de63c0dd24!2sNawabganj%2C%20Kanpur%2C%20Uttar%20Pradesh%20208002!5e0!3m2!1sen!2sin!4v1694472576681!5m2!1sen!2sin" width="600" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
            <div className="col-lg-6 col-md-12">
              <div className="card p-5">
                <h2 className='footer-title mb-3'><b>Contact Us</b></h2>
                <p className='mb-2'><b>Address:</b> Nawabganj, Kanpur 208002</p>
                <p className='mb-2'><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +91XXXXXXXXXX</a></p>
                ...
                <div className=" d-flex align-items-center justify-content-center">
                  <div className="row g-3">
                    <div className="col-md-6">
                      <input type="text" className="form-control" placeholder="Dhruv" aria-label="First name" />
                    </div>
                    <div className="col-md-6">
                      <input type="text" className="form-control" placeholder="Tyagi" aria-label="Last name" />
                    </div>
                    <div className='col-12'>
                      <label htmlFor="exampleFormControlInput1" className="form-label mb-3">Type your email</label>
